...
?>
    ...
    <article class="page-container">
        <form class="form form-horizontal" id="form1">
                ...
                <div class="formControls col-xs-3 col-md-3 col-sm-6"> <span class="select-box" style="width:150px;">
                    <select class="select" name="name" id="name" size="1">
                        ...
                        foreach ($liver as $key => $val) {
                            ?>
                            <option value="<?php echo $val['id']; ?>" <?php if (!$key) {
                                echo 'selected';
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-5 col-md-5 col-sm-5">
                    ...
                    <p class="textarea-numberbar"><em
                                class="textarea-length">0</em>/300
                    </p>
                </div>
            </div>
            ...
            <div class="row cl" id="upload_img">
        ...
        $(function () {
            ...
            $("#form1").validate({
                ...
                submitHandler: function (form) {
                    Msg.loading();
                    $.post('<?php echo U('live/graphic_post');?>', $("#form1").serialize(), function (res) {
                        Msg.hide();
                        if (res.status == 1) {
