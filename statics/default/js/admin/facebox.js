(function ($) {
    ...
    $.extend($.facebox, {
        settings: {
            ...
            resize: false,
            overlay: true,
            loadingImage: PUBLIC_URL + 'images/admin/loading.gif',
            closeImage: PUBLIC_URL + 'images/admin/closelabel.gif',
          ...
          <tbody> \
            ...
            <tr> \
              ...
              <td class="body"><div class="toper"> \
                  <a href="#" class="close"> \
                    <img src="' + PUBLIC_URL + 'images/admin/closelabel.gif" title="关闭" class="close_image" /> \
                  </a> \
            ...
            $(document).trigger('facebox-loading.facebox')
    ...
    function init(settings) {
        ...
        if ($.facebox.settings.fixed) {
            $(window).scroll(function () {
                $.facebox.fixed();
            });
        }
        if ($.facebox.settings.resize) {
    ...
    function fillFaceboxFromAjax(href, klass) {
        $.get(href, {"facebox": 1}, function (data) {
            $.facebox.reveal(data, klass)
        })
    }
